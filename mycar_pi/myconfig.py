...
DRIVE_TRAIN_TYPE = "BT_ARDUINO" # SERVO_ESC|DC_STEER_THROTTLE|DC_TWO_WHEEL|SERVO_HBRIDGE_PWM|PIGPIO_PWM|MM1|MOCK|BT_ARDUINO|SERIAL_ARDUINO
...
#CONTROLLER_TYPE='rc3'               #(ps3|ps4|xbox|nimbus|wiiu|F710|rc3|MM1|custom) custom will run the my_joystick.py controller written by the `donkey createjs` command
#USE_NETWORKED_JS = True            #should we listen for remote joystick control over the network?
#NETWORK_JS_SERVER_IP = "192.168.1.101"#when listening for network joystick control, which ip is serving this information
