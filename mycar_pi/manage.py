...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[]):
    ...
    class DriveMode:
        def run(self, mode,
            ...
            #print(f'{pilot_angle}, {pilot_throttle}, {mode}')
            if mode == 'user':
    ...
    elif cfg.DRIVE_TRAIN_TYPE == "BT_ARDUINO":
        from donkeycar.parts.actuator import BT_Arduino_Controller
        bt_controller = BT_Arduino_Controller(cfg.BT_DEVICE)
        
        V.add(bt_controller,
                inputs=['throttle', 'angle'])

    elif cfg.DRIVE_TRAIN_TYPE == "SERIAL_ARDUINO":
        from donkeycar.parts.actuator import Serial_Arduino_Controller
        serial_controller = Serial_Arduino_Controller(cfg.SERIAL_DEVICE)

        V.add(serial_controller,
                inputs=['throttle', 'angle'])
